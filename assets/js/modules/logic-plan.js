  ...
  if (href.includes("plan.html")) {
    ...
    class App {
      ...
      _selectingOption(e) {
        ...
        const planReply =
          clickdPreferences.querySelectorAll("[data-selecting]");
      ...
      document.querySelector(`[data-how="${index}"]`).innerText = price[index];
        ...
        function updatingModalPricePerUnit() {
          const sectionDeliver = document.querySelector(
            '[data-preference="4"]'
          );
          const planReplyArr =
            sectionDeliver.querySelectorAll("[data-selecting]");
      ...
      _updatePriceModal(title) {
        ...
        if (title.includes("Every week")) {
          const price =
            +document.querySelector('[data-how="0"]').textContent.slice(1, -1) *
            4;
          updatePriceModal(price);
        }
        if (title.includes("Every 2 weeks")) {
          const price =
            +document.querySelector('[data-how="1"]').textContent.slice(1, -1) *
            2;
          updatePriceModal(price);
        }
        if (title.includes("Every month")) {
          const price =
            +document.querySelector('[data-how="2"]').textContent.slice(1, -1) *
            1;
          updatePriceModal(price);
        }
      }
