...
var _logicPlanJs = require("./modules/logic-plan.js");
var _logicPlanJsDefault = parcelHelpers.interopDefault(_logicPlanJs);
var _animationJs = require("./modules/animation.js");
var _animationJsDefault = parcelHelpers.interopDefault(_animationJs);
var _darkModeJs = require("./modules/dark-mode.js");
var _darkModeJsDefault = parcelHelpers.interopDefault(_darkModeJs);
(0, _logicPlanJsDefault.default)();
(0, _animationJsDefault.default)();
(0, _darkModeJsDefault.default)();

},{"./modules/logic-plan.js":"kCo1q","./modules/animation.js":"kX3Pu","./modules/dark-mode.js":"hcuPP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kCo1q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function planApp() {
    if (href.includes("plan.html")) {
        ...
        class App {
            ...
            _eventClick() {
                planSelectionContainer.addEventListener("click", this._workingClick.bind(this));
            }
            _workingClick(e) {
                this._accordion(e);
            ...
            _accordion(e) {
                ...
                if (!question.nextElementSibling.classList.contains("show")) return clickBtn.setAttribute("aria-expanded", "false");
                ...
                if (clickdPreferences.matches(`[data-preference="0"]`)) {
                    if (title.includes("Capsule")) {
                        ...
                        if (this.#checkedSelection) {
                            ...
                            document.querySelector(".btn-box").querySelector('[data-disabled="blockGrind"]').classList.remove("block");
                            this.#checked = false;
                        }
                    }
                }
            ...
            _blockGrind(pro, opa) {
                ...
                document.querySelector(".plan__item:nth-child(4)").classList[`${pro}`]("block");
                document.querySelector('[data-disabled="blockGrind"]').classList[`${pro}`]("block");
            }
            _activation_button(clickdPreferences) {
                this.#arrCheckButton.forEach((_, index)=>{
                    if (clickdPreferences.matches(`[data-preference="${index}"]`)) this.#arrCheckButton[index] = 1;
                    if (clickdPreferences.matches(`[data-preference="${index === 3 && 3}"]`)) {
                        this.#checked = true;
                    ...
                    if (this.#checked) {
                        ...
                        if (this.#valided) {
                            ...
                            document.querySelector(".btn-box").querySelector('[data-disabled="blockGrind"]').classList.add("block");
                        }
                    }
                });
            }
            ...
            _updatePriceModal(title) {
                ...
                function updatePriceModal(price) {
                    document.querySelector(".modal__price").textContent = `$${price.toFixed(2)}/mo`;
                }
                if (title.includes("Every week")) {
                    const price = +document.querySelector('[data-how="0"]').textContent.slice(1, -1) * 4;
                    updatePriceModal(price);
                }
                if (title.includes("Every 2 weeks")) {
                    const price1 = +document.querySelector('[data-how="1"]').textContent.slice(1, -1) * 2;
                    updatePriceModal(price1);
                }
                if (title.includes("Every month")) {
                    const price2 = +document.querySelector('[data-how="2"]').textContent.slice(1, -1) * 1;
                    updatePriceModal(price2);
                }
            }
        }
        const app = new App();
        ...
        const openModal = function(e) {
            ...
            orderModal.querySelector("[data-modal='modal--complet']").classList.add("activeColor");
        };
...
},{}],"kX3Pu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = animationFunction;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hcuPP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function darkMode() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["apHCA","5wnyu"], "5wnyu", "parcelRequire1dfa")
